...
namespace hotel_reservation.Controllers
{
    public class CreditCardsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CreditCardID,CardType,CardNumber,ExpMonth,ExpYear,Name")] CreditCard creditCard, int? id)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CreditCardID,CardType,CardNumber,ExpMonth,ExpYear,Name")] CreditCard creditCard)
        {
            if (ModelState.IsValid)
            {
